...
urlpatterns = [
    ...
    path('eliminarEntregable/<curso_entregable>', eliminarEntregable, name="eliminarEntregable"),
    ...
    path('editarEntregable/<curso_entregable>', editarEntregable, name="editarEntregable"),
